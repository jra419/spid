...
df = pd.DataFrame(columns=['ip_src', 'ip_dst', 'cm_ip_src_ip_dst', 'cm_ip_dst_port_21', 'cm_ip_dst_port_22',
                           'cm_ip_dst_port_80', 'cm_ip_dst_tcp_syn', 'cm_ip_dst_tcp_ack', 'cm_ip_dst_tcp_rst',
                           'cm_ip_dst_icmp', 'bm_ip_src', 'bm_ip_dst', 'bm_ip_src_port_src', 'bm_ip_src_port_dst',
...
df_final_combined = pd.DataFrame(columns=['ip_src', 'ip_dst', 'cm_ip_src_ip_dst', 'cm_ip_dst_port_21',
                                          ...
                                          'bm_ip_dst_port_src', 'bm_ip_dst_port_dst', 'isolated_kmeans',
                                          'isolated_dbscan'])

df_columns = df[['ip_src', 'ip_dst', 'cm_ip_src_ip_dst', 'cm_ip_dst_port_21', 'cm_ip_dst_port_22', 'cm_ip_dst_port_80',
                 'cm_ip_dst_tcp_syn', 'cm_ip_dst_tcp_ack', 'cm_ip_dst_tcp_rst', 'cm_ip_dst_icmp', 'bm_ip_src',
                 'bm_ip_dst', 'bm_ip_src_port_src', 'bm_ip_src_port_dst', 'bm_ip_dst_port_src', 'bm_ip_dst_port_dst']]
